...
public class SellView extends View {
    ...
    public SellView() {
        ...
        ActionBar actionBar = new ActionBar(new dat.views.components.Action[]{
                new dat.views.components.Action("Khách hàng", GoogleMaterialDesignIcons.PERSON, new Color(104, 46, 206), chooserCustomer()),
                new dat.views.components.Action("Khuyến mãi", GoogleMaterialDesignIcons.RECEIPT, new Color(104, 46, 206), chooserPromotion()),
