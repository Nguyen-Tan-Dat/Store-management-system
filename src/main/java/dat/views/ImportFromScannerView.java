...
import dat.utils.*;
import dat.utils.*;
import dat.views.components.Action;
import dat.views.components.*;
import dat.views.components.*;
...
public class ImportFromScannerView extends View {
    ...
    public ImportFromScannerView() {
        ...
        ActionBar actionBar = new ActionBar(new dat.views.components.Action[]{
                new dat.views.components.Action("", GoogleMaterialDesignIcons.ARROW_BACK, new Color(104, 46, 206), back()),
                new dat.views.components.Action("Nhà cung cấp", GoogleMaterialDesignIcons.PERSON, new Color(104, 46, 206), chooserSupplier()),
                new dat.views.components.Action("Sản phẩm", GoogleMaterialDesignIcons.SHOPPING_BASKET, new Color(104, 46, 206), chooserProduct()),
                new dat.views.components.Action("Quét", GoogleMaterialDesignIcons.SCANNER, new Color(104, 46, 206), scan()),
                new dat.views.components.Action("Xóa", GoogleMaterialDesignIcons.DELETE, new Color(190, 45, 45), delete()),
