...
import dat.views.components.ActionBar;
...
public class ManagementView extends SeeView {
    ...
    public ManagementView(Control control) {
        super(control);
        actionBar = new ActionBar(new dat.views.components.Action[]{
                new dat.views.components.Action("Thêm", GoogleMaterialDesignIcons.ADD, new Color(104, 46, 206), add()),
                new dat.views.components.Action("Cập nhật", GoogleMaterialDesignIcons.UPDATE, new Color(104, 46, 206), update()),
